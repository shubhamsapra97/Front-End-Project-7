...
function getAdj(x){
  switch(x) {
    ...
    case "scientific":
      ...
      return scientific;
    default:
      var scientific_ = ["scientific", "technical", "digital", "programming", "calculating", "formulating", "cyberpunk", "mechanical", "technological",
      "innovative", "brainy", "chemical", "quantum", "astro", "space", "theoretical", "atomic", "electronic", "gaseous", "investigative", "solar",
      "extinct", "galactic"];
      return scientific_;
  }
...
function getNoun(y) {
  switch(y) {
    ...
    case "scifi":
      ...
      return scifi;
    default:
      var scifi_ = ["robot", "alien", "raygun", "spaceship", "UFO", "rocket", "phaser", "astronaut", "spaceman", "planet", "star", "galaxy",
      "computer", "future", "timeMachine", "wormHole", "timeTraveler", "scientist", "invention", "martian", "pluto", "jupiter", "saturn", "mars",
      "quasar", "blackHole", "warpDrive", "laser", "orbit", "gears", "molecule", "electron", "neutrino", "proton", "experiment", "photon", "apparatus",
      "universe", "gravity", "darkMatter", "constellation", "circuit", "asteroid"];
      return scifi_;
...
var makeRandomPizza = function() {
  ...
  for (var k = 0; k < numberOfNonMeats; k++) {
    pizza = pizza + ingredientItemizer(selectRandomNonMeat());
  }

  for (var j = 0; j < numberOfCheeses; j++) {
...
function updatePositions() {
 ...
 var calc = document.body.scrollTop / 1250;

var phase;

for (var i = 0; i < items.length; i++) {
  phase = Math.sin(calc + (i % 5));
...
num_pizzas = (screen_height/s) * cols;
